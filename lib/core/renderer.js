...
module.exports = class Renderer {
  ...
  renderRoute(url, context = {}) {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      ...
      if (_this4.noSSR || spa) {
        const { HTML_ATTRS, BODY_ATTRS, HEAD, BODY_SCRIPTS, getPreloadFiles } = yield _this4.metaRenderer.render(context);
        ...
        if (url.includes(_this4.options.build.publicPath) || url.includes('__webpack')) {
          const err = { statusCode: 404, message: _this4.options.messages.error_404, name: 'ResourceNotFound' };
          throw err;
        }
