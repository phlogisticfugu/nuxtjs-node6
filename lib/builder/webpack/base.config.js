...
module.exports = function webpackBaseConfig({ name, isServer }) {
  const config = {
    ...
    module: {
      ...
      }, { test: /\.css$/, use: styleLoader.call(this, 'css') }, { test: /\.less$/, use: styleLoader.call(this, 'less', 'less-loader') }, { test: /\.sass$/, use: styleLoader.call(this, 'sass', { loader: 'sass-loader', options: { indentedSyntax: true } }) }, { test: /\.scss$/, use: styleLoader.call(this, 'scss', 'sass-loader') }, { test: /\.styl(us)?$/, use: styleLoader.call(this, 'stylus', 'stylus-loader') }, {
  ...
  if (extractCSS) {
    const extractOptions = (0, _assign2.default)({ filename: this.getFileName('css') }, typeof extractCSS === 'object' ? extractCSS : {});
