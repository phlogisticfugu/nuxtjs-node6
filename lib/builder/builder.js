  ...
  generateRoutesAndFiles() {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      ...
      const templateVars = {
        ...
        const layoutsFiles = yield glob('layouts/**/*.{vue,js}', {
          cwd: _this2.options.srcDir,
          ignore: [`layouts/**/${_this2.options.ignorePrefix}*.{vue,js}`]
        });
      ...
      if (_this2._nuxtPages) {
        ...
        const files = {};(yield glob('pages/**/*.{vue,js}', {
          cwd: _this2.options.srcDir,
          ignore: [`pages/**/${_this2.options.ignorePrefix}*.{vue,js}`]
        })).forEach(function (f) {
