...
module.exports = class Generator {
  ...
  afterGenerate() {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      ...
      const { html } = yield _this5.nuxt.renderRoute('/', { spa: true });
      yield writeFile(fallbackPath, html, 'utf8');
    })();
  }
